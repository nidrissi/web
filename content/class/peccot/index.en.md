...
<div class="alert alert-info"><a class="alert-link" href="{{< ref "research/peccot" >}}peccot.pdf"><i class="bi bi-file-earmark-text me-1"></i>Lecture notes are available here.</a></span></div>
