...
I defended [my doctorate]({{< ref "/research/thesis/index.en.md" >}}) on November 17th.
...
With Ricardo Campos, Pascal Lambrechts, and Thomas Willwacher, we have [uploaded a preprint]({{< ref "/research/config-boundary/index.en.md" >}}) of our work on configuration spaces of manifolds with boundary, a follow-up to [my previous paper]({{< ref "/research/ls-model/index.en.md" >}}) and [the paper of Ricardo and Thomas](https://arxiv.org/abs/1604.02043).
